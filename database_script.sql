...
-- Execute este script em um banco SQLite para criar todas as tabelas necessárias
...
('Maria Santos', 'maria@email.com', '11888888888', 1),
('Pedro Costa', 'pedro@email.com', '11777777777', 1),
('Ana Oliveira', 'ana@email.com', '11666666666', 1);
